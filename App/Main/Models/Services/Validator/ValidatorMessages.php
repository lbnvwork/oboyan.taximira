...
class ValidatorMessages
{
     ...
     * @return $this
     */
    public function setReportMessage(): ValidatorMessages
    {
        $message = '';
     ...
     * @return $this
     */
    public function setParameterMessages(): ValidatorMessages
    {
        $messages = [];
        if ($this->validator->isValid()) {
     ...
     * @return array
     */
    public function getParameterMessages(): array
    {
     ...
     * @return $this
     */
    public function setDefaultMessage(string $message): ValidatorMessages
    {
     ...
     * @return $this
     */
    public function prepareMessages(string $defaultMessage = null, string $successMessage = null): ValidatorMessages
    {
     ...
     */
    public function setSuccessMessage(string $successMessage): ValidatorMessages
    {
     ...
     * @return array
     */
    public function getAllErrorMessagesArr(): array
    {
        $errorMessagesArr = [];
